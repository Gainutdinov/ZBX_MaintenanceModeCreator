...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.listWidget_2, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.name_le, 6, 0, 1, 2)
        self.dscr_le = QtWidgets.QLineEdit(self.centralwidget)
        self.dscr_le.setObjectName("dscr_le")
        self.gridLayout.addWidget(self.dscr_le, 10, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.textEdit, 12, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.filter_le, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.filter_le.setPlaceholderText(_translate("MainWindow", "type here to filter the available hosts"))
